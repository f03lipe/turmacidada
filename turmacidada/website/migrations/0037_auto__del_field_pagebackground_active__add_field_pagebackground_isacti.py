...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageBackground.isactive'
        db.add_column('website_pagebackground', 'isactive',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PageBackground.isactive'
        db.delete_column('website_pagebackground', 'isactive')
