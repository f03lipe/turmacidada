...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PageBackground.is_active'
        db.alter_column('website_pagebackground', 'is_active', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'PageBackground.is_active'
        db.alter_column('website_pagebackground', 'is_active', self.gf('django.db.models.fields.BooleanField')())
