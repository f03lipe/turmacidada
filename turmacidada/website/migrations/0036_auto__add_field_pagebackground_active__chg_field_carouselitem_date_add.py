...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageBackground.active'
        db.add_column('website_pagebackground', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'CarouselItem.date_added'
        db.alter_column('website_carouselitem', 'date_added', self.gf('django.db.models.fields.DateField')(auto_now=True))

    def backwards(self, orm):
        # Deleting field 'PageBackground.active'
        db.delete_column('website_pagebackground', 'active')


        # Changing field 'CarouselItem.date_added'
        db.alter_column('website_carouselitem', 'date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
