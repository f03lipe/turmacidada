...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamMember.member_since'
        db.add_column('website_teammember', 'member_since',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2007, 1, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeamMember.member_since'
        db.delete_column('website_teammember', 'member_since')
