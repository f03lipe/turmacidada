...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageBackground.date_added'
        db.add_column('website_pagebackground', 'date_added',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2012, 11, 20, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageBackground.date_added'
        db.delete_column('website_pagebackground', 'date_added')
