...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageBackground.header_color'
        db.add_column('website_pagebackground', 'header_color',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PageBackground.header_color'
        db.delete_column('website_pagebackground', 'header_color')
