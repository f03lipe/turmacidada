...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'website_carouselitem', 'date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CarouselItem.date_added'
        db.alter_column(u'website_carouselitem', 'date_added', self.gf('django.db.models.fields.DateField')(auto_now=True))
